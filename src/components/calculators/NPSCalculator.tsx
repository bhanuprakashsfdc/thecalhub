...
export default function NPSCalculator() {
  ...
  const [result, setResult] = useState<{ maturity: number; invested: number } | null>(null);
    ...
    <div className="mt-14 p-6 md:p-10 flex-1 overflow-y-auto">
      <div className="mb-12">
        ...
        <p className="text-neutral-400 max-w-xl text-lg leading-relaxed">
          Estimate your National Pension System corpus at retirement.
        </p>
      </div>
      ...
      <div className="max-w-lg">
        <div className="bg-surface-container-low rounded-xl p-6 border border-white/5">
          <div className="space-y-6">
            <div>
              <label className="block text-[10px] font-mono text-neutral-500 uppercase tracking-widest mb-2">Monthly Contribution</label>
            ...
            {result && (
              ...
              >
                <div className="flex items-center gap-2 text-primary-fixed mb-4">
                  ...
                  <span className="text-[10px] uppercase tracking-widest font-bold">NPS Corpus</span>
                </div>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-neutral-400 text-sm">Total Invested</span>
                    <span className="text-white font-bold">₹{result.invested.toLocaleString()}</span>
                  </div>
                  <div className="pt-3 border-t border-white/10 flex justify-between items-center">
                    <span className="text-neutral-400 text-sm">Estimated Corpus</span>
