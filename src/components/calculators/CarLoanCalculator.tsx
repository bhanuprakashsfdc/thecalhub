      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="bg-surface-container-low p-6 rounded-xl border border-white/5">
            <h3 className="text-lg font-bold text-white mb-4">About Car Loan Calculator</h3>
            <p className="text-neutral-400 text-sm leading-relaxed">Calculate your car loan EMIs, total interest, and total payment over the loan tenure.</p>
          </div>
        </div>
      </div>
    </div>
