...
import { Sparkles, Building2, Banknote, TrendingUp } from 'lucide-react';
    ...
    <div className="pt-24 pb-12 px-6 md:px-12 max-w-7xl mx-auto w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="bg-surface-container-low p-6 rounded-xl border border-white/5">
            <h3 className="text-lg font-bold text-white mb-4">About PPF Calculator</h3>
            <p className="text-neutral-400 text-sm leading-relaxed mb-4">
              Public Provident Fund (PPF) is a popular long-term savings scheme with sovereign guarantee. It offers tax-free interest and tax benefits under Section 80C.
            </p>
            <p className="text-neutral-400 text-sm leading-relaxed">
              <strong>Key Features:</strong> 15-year lock-in period, partial withdrawal allowed after 5 years, loan facility available, and tax-free maturity proceeds.
            </p>
          </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-neutral-400 text-xs leading-relaxed">
                  Maximize your PPF! Invest ₹1.5 Lakhs/year (max) for 15 years at 7.1% to get ₹41.6 Lakhs. The interest earned is completely tax-free!
                </p>
              </div>
            </div>
          </div>
