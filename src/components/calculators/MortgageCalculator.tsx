  ...
  return (
    <div className="pt-24 pb-12 px-6 md:px-12 max-w-7xl mx-auto w-full">
      <div className="mb-10">
        ...
        <h2 className="text-4xl font-extrabold text-white tracking-tight leading-none mb-4">Mortgage Calculator</h2>
        <p className="text-neutral-400 max-w-2xl text-lg leading-relaxed">
          Calculate your mortgage monthly payment, total interest, and total cost. Our free online calculator helps you understand your mortgage payments and plan your budget.
        </p>
        <div className="flex gap-2 mt-4">
          <span className="text-xs px-2 py-1 bg-white/5 text-neutral-400 rounded">Mortgage</span>
          <span className="text-xs px-2 py-1 bg-white/5 text-neutral-400 rounded">Monthly Payment</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="bg-surface-container-low p-6 rounded-xl border border-white/5">
            <h3 className="text-lg font-bold text-white mb-4">About Mortgage Calculator</h3>
            <p className="text-neutral-400 text-sm leading-relaxed mb-4">A mortgage is a loan used to buy property, where the property serves as collateral. Your monthly payment includes principal and interest.</p>
            <p className="text-neutral-400 text-sm leading-relaxed"><strong>Tip:</strong> Making extra payments can significantly reduce your total interest over the loan term.</p>
          </div>
        </div>
      </div>
    </div>
