      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input id="calorie-weight" type="number" value={weight} onChange={(e) => setWeight(Number(e.target.value))}
                  ...
                  aria-describedby="calorie-weight-desc"
                  className="w-full bg-surface-container-highest border-none rounded-lg py-4 px-4 text-white mono text-xl outline-none" />
                <span id="calorie-weight-desc" className="sr-only">Enter your weight in kilograms</span>
              </div>
              <div>
                ...
                <input id="calorie-height" type="number" value={height} onChange={(e) => setHeight(Number(e.target.value))}
                  ...
                  aria-describedby="calorie-height-desc"
                  className="w-full bg-surface-container-highest border-none rounded-lg py-4 px-4 text-white mono text-xl outline-none" />
                <span id="calorie-height-desc" className="sr-only">Enter your height in centimeters</span>
              </div>
              <div>
        ...
        <div className="lg:col-span-7 space-y-6">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
            ...
            <div className="flex items-baseline gap-2 mb-6" role="status" aria-live="polite">
