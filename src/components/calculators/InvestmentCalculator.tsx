    ...
    <div className="pt-24 pb-12 px-6 md:px-12 max-w-7xl mx-auto w-full">
      <div className="mb-10">
        ...
        <p className="text-neutral-400 max-w-2xl text-lg leading-relaxed">
          Calculate your investment growth over time. Our free calculator helps you project future value based on initial investment, monthly contributions, and expected returns.
        </p>
        ...
        <div className="lg:col-span-7 space-y-6">
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-2xl font-bold text-white mono">${Math.round(calculation.totalInvested).toLocaleString()}</p>
              </div>
              <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-surface-container-low p-6 rounded-xl border border-white/5">
              <label className="block text-[10px] uppercase tracking-[0.2em] text-neutral-500 font-bold mb-4">Investment Growth</label>
          ...
          <div className="bg-surface-container-low p-6 rounded-xl border border-white/5">
            <h3 className="text-lg font-bold text-white mb-4">About Investment Calculator</h3>
            <p className="text-neutral-400 text-sm leading-relaxed mb-4">This calculator projects your investment growth using compound interest with regular monthly contributions.</p>
            <p className="text-neutral-400 text-sm leading-relaxed"><strong>Formula:</strong> FV = P(1+r)^n + PMT × ((1+r)^n - 1) / r</p>
          </div>
        </div>
      </div>
    </div>
